...
class CartModuleService extends utils_1.ModulesSdkUtils.MedusaService(generateMethodForModels) {
    ...
    async addLineItems_(cartId, items, sharedContext = {}) {
        const cart = await this.cartService_.retrieve(cartId, { select: ["id"] }, sharedContext);
    ...
    async updateLineItemsWithSelector_(updates, sharedContext = {}) {
        ...
        for (const { selector, data } of updates) {
            const items = await this.lineItemService_.list({ ...selector }, {}, sharedContext);
            items.forEach((item) => {
                toUpdate.push({
                    ...data,
                    id: item.id,
    ...
    async addLineItemAdjustments(cartIdOrData, adjustments, sharedContext = {}) {
        const result = await this.addLineItemAdjustments_(cartIdOrData, adjustments, sharedContext);
        return await this.baseRepository_.serialize(result);
    }
    async addLineItemAdjustments_(cartIdOrData, adjustments, sharedContext = {}) {
        let addedAdjustments = [];
        if ((0, utils_1.isString)(cartIdOrData)) {
            const cart = await this.cartService_.retrieve(cartIdOrData, { select: ["id"], relations: ["items"] }, sharedContext);
    ...
    async upsertLineItemTaxLines_(taxLines, sharedContext = {}) {
        const result = await this.lineItemTaxLineService_.upsert(taxLines, sharedContext);
        return result;
    }
    async upsertLineItemAdjustments(adjustments, sharedContext = {}) {
        const result = await this.upsertLineItemAdjustments_(adjustments, sharedContext);
        return await this.baseRepository_.serialize(result);
    }
    async upsertLineItemAdjustments_(adjustments, sharedContext = {}) {
    ...
    async upsertShippingMethodTaxLines(taxLines, sharedContext = {}) {
        const result = await this.upsertShippingMethodTaxLines_(taxLines, sharedContext);
        return await this.baseRepository_.serialize(result);
    }
    async upsertShippingMethodTaxLines_(taxLines, sharedContext = {}) {
    ...
    async upsertShippingMethodAdjustments(adjustments, sharedContext = {}) {
        const result = await this.upsertShippingMethodAdjustments_(adjustments, sharedContext);
        return await this.baseRepository_.serialize(result);
    }
    async upsertShippingMethodAdjustments_(adjustments, sharedContext = {}) {
    ...
    async setLineItemAdjustments(cartId, adjustments, sharedContext = {}) {
        const result = await this.setLineItemAdjustments_(cartId, adjustments, sharedContext);
        return await this.baseRepository_.serialize(result);
    }
    async setLineItemAdjustments_(cartId, adjustments, sharedContext = {}) {
        const cart = await this.cartService_.retrieve(cartId, { select: ["id"], relations: ["items.adjustments"] }, sharedContext);
        const existingAdjustments = await this.lineItemAdjustmentService_.list({ item: { cart_id: cart.id } }, { select: ["id"] }, sharedContext);
    ...
    async setShippingMethodAdjustments(cartId, adjustments, sharedContext = {}) {
        const result = await this.setShippingMethodAdjustments_(cartId, adjustments, sharedContext);
        return await this.baseRepository_.serialize(result);
    }
    async setShippingMethodAdjustments_(cartId, adjustments, sharedContext = {}) {
        const cart = await this.cartService_.retrieve(cartId, { select: ["id"], relations: ["shipping_methods.adjustments"] }, sharedContext);
        const existingAdjustments = await this.shippingMethodAdjustmentService_.list({ shipping_method: { cart_id: cart.id } }, { select: ["id"] }, sharedContext);
        const adjustmentsSet = new Set(adjustments
            .map((a) => a?.id)
            .filter(Boolean));
        const toDelete = [];
    ...
    async addShippingMethodAdjustments(cartIdOrData, adjustments, sharedContext = {}) {
        const result = await this.addShippingMethodAdjustments_(cartIdOrData, adjustments, sharedContext);
        return await this.baseRepository_.serialize(result);
    }
    async addShippingMethodAdjustments_(cartIdOrData, adjustments, sharedContext = {}) {
        let addedAdjustments = [];
        if ((0, utils_1.isString)(cartIdOrData)) {
            const cart = await this.cartService_.retrieve(cartIdOrData, { select: ["id"], relations: ["shipping_methods"] }, sharedContext);
    ...
    async addLineItemTaxLines(cartIdOrData, taxLines, sharedContext = {}) {
        const result = await this.addLineItemTaxLines_(cartIdOrData, taxLines, sharedContext);
        return await this.baseRepository_.serialize(result);
    }
    async addLineItemTaxLines_(cartIdOrData, taxLines, sharedContext = {}) {
        let addedTaxLines;
        if ((0, utils_1.isString)(cartIdOrData)) {
            // existence check
            const cart = await this.cartService_.retrieve(cartIdOrData, { select: ["id"] }, sharedContext);
            if (!cart) {
                throw new utils_1.MedusaError(utils_1.MedusaError.Types.INVALID_DATA, `Cart with id ${cartIdOrData} does not exist`);
            }
    ...
    async setLineItemTaxLines(cartId, taxLines, sharedContext = {}) {
        const result = await this.setLineItemTaxLines_(cartId, taxLines, sharedContext);
        return await this.baseRepository_.serialize(result);
    }
    async setLineItemTaxLines_(cartId, taxLines, sharedContext = {}) {
    ...
    async addShippingMethodTaxLines(cartIdOrData, taxLines, sharedContext = {}) {
        const result = await this.addShippingMethodTaxLines_(cartIdOrData, taxLines, sharedContext);
        return await this.baseRepository_.serialize(result);
    }
    async addShippingMethodTaxLines_(cartIdOrData, taxLines, sharedContext = {}) {
        let addedTaxLines;
        if ((0, utils_1.isString)(cartIdOrData)) {
            // existence check
            const cart = await this.cartService_.retrieve(cartIdOrData, { select: ["id"] }, sharedContext);
    ...
    async setShippingMethodTaxLines(cartId, taxLines, sharedContext = {}) {
        const result = await this.setShippingMethodTaxLines_(cartId, taxLines, sharedContext);
        return await this.baseRepository_.serialize(result);
    }
    async setShippingMethodTaxLines_(cartId, taxLines, sharedContext = {}) {
        const normalizedTaxLines = taxLines.map((taxLine) => {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Array, Object]),
    __metadata("design:returntype", Promise)
], CartModuleService.prototype, "addLineItemAdjustments_", null);
__decorate([
    (0, utils_1.InjectManager)(),
    (0, utils_1.EmitEvents)(),
    __param(1, (0, utils_1.MedusaContext)()),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Array, Object]),
    __metadata("design:returntype", Promise)
], CartModuleService.prototype, "upsertLineItemTaxLines_", null);
__decorate([
    (0, utils_1.InjectManager)(),
    (0, utils_1.EmitEvents)(),
    __param(1, (0, utils_1.MedusaContext)()),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Array, Object]),
    __metadata("design:returntype", Promise)
], CartModuleService.prototype, "upsertLineItemAdjustments_", null);
__decorate([
    (0, utils_1.InjectManager)(),
    (0, utils_1.EmitEvents)(),
    __param(1, (0, utils_1.MedusaContext)()),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Array, Object]),
    __metadata("design:returntype", Promise)
], CartModuleService.prototype, "upsertShippingMethodTaxLines_", null);
__decorate([
    (0, utils_1.InjectManager)(),
    (0, utils_1.EmitEvents)(),
    __param(1, (0, utils_1.MedusaContext)()),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Array, Object]),
    __metadata("design:returntype", Promise)
], CartModuleService.prototype, "upsertShippingMethodAdjustments_", null);
__decorate([
    (0, utils_1.InjectManager)(),
    (0, utils_1.EmitEvents)(),
    __param(2, (0, utils_1.MedusaContext)()),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, Array, Object]),
    __metadata("design:returntype", Promise)
], CartModuleService.prototype, "setLineItemAdjustments_", null);
__decorate([
    (0, utils_1.InjectManager)(),
    (0, utils_1.EmitEvents)(),
    __param(2, (0, utils_1.MedusaContext)()),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, Array, Object]),
    __metadata("design:returntype", Promise)
], CartModuleService.prototype, "setShippingMethodAdjustments_", null);
__decorate([
    (0, utils_1.InjectManager)(),
    (0, utils_1.EmitEvents)(),
    __param(2, (0, utils_1.MedusaContext)()),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Array, Object]),
    __metadata("design:returntype", Promise)
], CartModuleService.prototype, "addShippingMethodAdjustments_", null);
__decorate([
    (0, utils_1.InjectManager)(),
    (0, utils_1.EmitEvents)(),
    __param(2, (0, utils_1.MedusaContext)()),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object, Object]),
    __metadata("design:returntype", Promise)
], CartModuleService.prototype, "addLineItemTaxLines_", null);
__decorate([
    (0, utils_1.InjectManager)(),
    (0, utils_1.EmitEvents)(),
    __param(2, (0, utils_1.MedusaContext)()),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, Array, Object]),
    __metadata("design:returntype", Promise)
], CartModuleService.prototype, "setLineItemTaxLines_", null);
__decorate([
    (0, utils_1.InjectManager)(),
    (0, utils_1.EmitEvents)(),
    __param(2, (0, utils_1.MedusaContext)()),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object, Object]),
    __metadata("design:returntype", Promise)
], CartModuleService.prototype, "addShippingMethodTaxLines_", null);
__decorate([
    (0, utils_1.InjectManager)(),
    (0, utils_1.EmitEvents)(),
    __param(2, (0, utils_1.MedusaContext)()),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, Array, Object]),
    __metadata("design:returntype", Promise)
], CartModuleService.prototype, "setShippingMethodTaxLines_", null);
