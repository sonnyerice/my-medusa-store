...
class CustomerModuleService extends (0, utils_1.MedusaService)({
    ...
    async updateCustomers(idsOrSelector, data, sharedContext = {}) {
        const customers = await this.updateCustomers_(idsOrSelector, data, sharedContext);
        return await this.baseRepository_.serialize(customers);
    }
    async updateCustomers_(idsOrSelector, data, sharedContext = {}) {
        let updateData;
    ...
    async createCustomerGroups(dataOrArrayOfData, sharedContext = {}) {
        const groups = await this.createCustomerGroups_(dataOrArrayOfData, sharedContext);
        return await this.baseRepository_.serialize(groups);
    }
    async createCustomerGroups_(dataOrArrayOfData, sharedContext = {}) {
    ...
    async updateCustomerGroups(groupIdOrSelector, data, sharedContext = {}) {
        const groups = await this.updateCustomerGroups_(groupIdOrSelector, data, sharedContext);
        return await this.baseRepository_.serialize(groups);
    }
    async updateCustomerGroups_(groupIdOrSelector, data, sharedContext = {}) {
        let updateData;
    ...
    async addCustomerToGroup_(data, sharedContext = {}) {
    ...
    async updateCustomerAddresses(addressIdOrSelector, data, sharedContext = {}) {
        const addresses = await this.updateCustomerAddresses_(addressIdOrSelector, data, sharedContext);
        return await this.baseRepository_.serialize(addresses);
    }
    async updateCustomerAddresses_(addressIdOrSelector, data, sharedContext = {}) {
        let updateData;
    ...
    async removeCustomerFromGroup_(data, sharedContext = {}) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object, Object]),
    __metadata("design:returntype", Promise)
], CustomerModuleService.prototype, "updateCustomers_", null);
__decorate([
    (0, utils_1.InjectManager)(),
    (0, utils_1.EmitEvents)()
    // @ts-expect-error
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], CustomerModuleService.prototype, "createCustomerGroups_", null);
__decorate([
    (0, utils_1.InjectManager)(),
    (0, utils_1.EmitEvents)()
    // @ts-expect-error
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object, Object]),
    __metadata("design:returntype", Promise)
], CustomerModuleService.prototype, "updateCustomerGroups_", null);
__decorate([
    (0, utils_1.InjectManager)(),
    (0, utils_1.EmitEvents)(),
    __param(1, (0, utils_1.MedusaContext)()),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], CustomerModuleService.prototype, "addCustomerToGroup_", null);
__decorate([
    (0, utils_1.InjectManager)(),
    (0, utils_1.EmitEvents)()
    // @ts-expect-error
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object, Object]),
    __metadata("design:returntype", Promise)
], CustomerModuleService.prototype, "updateCustomerAddresses_", null);
__decorate([
    (0, utils_1.InjectManager)(),
    (0, utils_1.EmitEvents)(),
    __param(1, (0, utils_1.MedusaContext)()),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], CustomerModuleService.prototype, "removeCustomerFromGroup_", null);
