...
:root {
  ...
  --borders-interactive-with-focus:
    ...
    0px 0px 0px 1px rgba(37, 99, 235, 1),
    0px 0px 0px 2px rgba(255, 255, 255, 1),
    0px 0px 0px 4px rgba(37, 99, 235, 0.6);
...
.dark {
  ...
  --elevation-modal:
    ...
    0px 8px 16px 0px rgba(0, 0, 0, 0.32);
  --elevation-commandbar:
    0px 0px 0px 0.75px rgba(24, 24, 27, 1) inset,
    0px 0px 0px 1.25px rgba(255, 255, 255, 0.1) inset,
    0px 4px 8px 0px rgba(0, 0, 0, 0.32),
    0px 8px 16px 0px rgba(0, 0, 0, 0.32);
  --elevation-tooltip:
    0px -1px 0px 0px rgba(255, 255, 255, 0.04),
...
.txt-large {
  font-size: 1rem;
  line-height: 1.600000023841858rem;
  font-weight: 400;
  font-family:
    Inter,
    ui-sans-serif,
...
.\[\&_tr\]\:last-of-type\:\!border-b:last-of-type tr {
