...
export default class FulfillmentModuleService extends FulfillmentModuleService_base implements IFulfillmentModuleService {
    ...
    upsertShippingOptionTypes(data: FulfillmentTypes.UpsertShippingOptionTypeDTO, sharedContext?: Context): Promise<FulfillmentTypes.ShippingOptionTypeDTO>;
    protected updateShippingOptionTypes_(data: FulfillmentTypes.UpsertShippingOptionTypeDTO[] | FulfillmentTypes.UpsertShippingOptionTypeDTO, sharedContext: Context): Promise<InferEntityType<typeof ShippingOptionType>[]>;
    ...
    protected updateShippingProfiles_(idOrSelector: string | FulfillmentTypes.FilterableShippingProfileProps, data: FulfillmentTypes.UpdateShippingProfileDTO, sharedContext?: Context): Promise<InferEntityType<typeof ShippingProfile>[]>;
    ...
    upsertShippingProfiles(data: FulfillmentTypes.UpsertShippingProfileDTO, sharedContext?: Context): Promise<FulfillmentTypes.ShippingProfileDTO>;
    protected upsertShippingProfiles_(data: FulfillmentTypes.UpsertShippingProfileDTO[] | FulfillmentTypes.UpsertShippingProfileDTO, sharedContext?: Context): Promise<InferEntityType<typeof ShippingProfile>[] | InferEntityType<typeof ShippingProfile>>;
