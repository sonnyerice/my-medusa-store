...
export default class InventoryModuleService extends InventoryModuleService_base implements IInventoryService {
    ...
    updateInventoryLevels(updates: InventoryTypes.UpdateInventoryLevelInput, context?: Context): Promise<InventoryTypes.InventoryLevelDTO>;
    updateInventoryLevels_(updates: InventoryTypes.UpdateInventoryLevelInput[], context?: Context): Promise<any[]>;
    /**
    ...
    protected softDeleteReservationItems_(ids: string | string[], config?: SoftDeleteReturn<string>, context?: Context): Promise<void>;
    restoreReservationItems(ids: string | string[], config?: RestoreReturn<string>, context?: Context): Promise<void>;
    protected restoreReservationItems_(ids: string | string[], config?: RestoreReturn<string>, context?: Context): Promise<void>;
    deleteReservationItemByLocationId(locationId: string | string[], context?: Context): Promise<void>;
    protected deleteReservationItemByLocationId_(locationId: string | string[], context?: Context): Promise<void>;
    /**
    ...
    protected deleteReservationItemsByLineItem_(lineItemId: string | string[], context?: Context): Promise<void>;
    /**
     * Deletes reservation items by line item
     * @param lineItemId - the id of the line item associated with the reservation item
     * @param context
    ...
    protected restoreReservationItemsByLineItem_(lineItemId: string | string[], context?: Context): Promise<void>;
    /**
