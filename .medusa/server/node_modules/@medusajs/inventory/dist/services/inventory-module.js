...
class InventoryModuleService extends (0, utils_1.MedusaService)({
    ...
    async updateReservationItems_(input, context = {}) {
        ...
        const reservationItems = await this.reservationItemService_.list({ id: ids }, {}, context);
    ...
    async softDeleteReservationItems_(ids, config, context = {}) {
        const reservations = await this.reservationItemService_.list({ id: ids }, {}, context);
    ...
    async restoreReservationItems_(ids, config, context = {}) {
    ...
    async deleteReservationItemByLocationId_(locationId, context = {}) {
        const reservations = await this.reservationItemService_.list({ location_id: locationId }, {}, context);
    ...
    async deleteReservationItemsByLineItem_(lineItemId, context = {}) {
        const reservations = await this.reservationItemService_.list({ line_item_id: lineItemId }, {}, context);
    ...
    async restoreReservationItemsByLineItem_(lineItemId, context = {}) {
        const reservations = await this.reservationItemService_.list({ line_item_id: lineItemId }, {}, context);
    ...
    async adjustInventory_(inventoryItemId, locationId, adjustment, context = {}) {
        const [inventoryLevel] = await this.inventoryLevelService_.list({ inventory_item_id: inventoryItemId, location_id: locationId }, {}, context);
        if (!inventoryLevel) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object, Object]),
    __metadata("design:returntype", Promise)
], InventoryModuleService.prototype, "softDeleteReservationItems_", null);
__decorate([
    (0, utils_1.InjectManager)(),
    (0, utils_1.EmitEvents)()
    // @ts-expect-error
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object, Object]),
    __metadata("design:returntype", Promise)
], InventoryModuleService.prototype, "restoreReservationItems_", null);
__decorate([
    (0, utils_1.InjectManager)(),
    (0, utils_1.EmitEvents)(),
    __param(1, (0, utils_1.MedusaContext)()),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], InventoryModuleService.prototype, "deleteReservationItemByLocationId_", null);
__decorate([
    (0, utils_1.InjectManager)(),
    (0, utils_1.EmitEvents)(),
    __param(1, (0, utils_1.MedusaContext)()),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], InventoryModuleService.prototype, "deleteReservationItemsByLineItem_", null);
__decorate([
    (0, utils_1.InjectManager)(),
    (0, utils_1.EmitEvents)(),
    __param(1, (0, utils_1.MedusaContext)()),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], InventoryModuleService.prototype, "restoreReservationItemsByLineItem_", null);
__decorate([
    (0, utils_1.InjectManager)(),
    (0, utils_1.EmitEvents)(),
