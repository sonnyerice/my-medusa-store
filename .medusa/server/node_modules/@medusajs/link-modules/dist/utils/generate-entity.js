...
function generateEntity(joinerConfig, primary, foreign) {
    ...
    const tableName = joinerConfig.databaseConfig?.tableName ??
        (0, utils_1.composeTableName)(primary.serviceName, primary.foreignKey, foreign.serviceName, foreign.foreignKey).toLowerCase();
    ...
    return new core_1.EntitySchema({
        ...
        tableName: (0, utils_1.compressName)(tableName),
        properties: {
            id: {
                type: "string",
                nullable: false,
        ...
        indexes: [
            ...
            },
            {
                ...
                expression: "CREATE INDEX IF NOT EXISTS " +
                    ...
                    hashTableName +
                    '" ON "' +
                    (0, utils_1.compressName)(tableName) +
                    '" ("' +
