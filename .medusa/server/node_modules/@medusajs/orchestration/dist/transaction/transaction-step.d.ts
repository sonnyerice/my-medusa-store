...
import { DistributedTransactionType, TransactionPayload } from "./distributed-transaction";
...
export type TransactionStepHandler = (actionId: string, handlerType: TransactionHandlerType, payload: TransactionPayload, transaction: DistributedTransactionType, step: TransactionStep, orchestrator: TransactionOrchestrator) => Promise<unknown>;
/**
...
//# sourceMappingURL=transaction-step.d.ts.map