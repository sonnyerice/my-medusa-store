...
export default class OrderModuleService extends OrderModuleService_base implements IOrderModuleService {
    ...
    retrieveOrder(id: string, config?: FindConfig<any> | undefined, sharedContext?: Context): Promise<OrderTypes.OrderDTO>;
    listOrders(filters?: any, config?: FindConfig<any> | undefined, sharedContext?: Context): Promise<OrderTypes.OrderDTO[]>;
    protected listOrders_(filters?: any, config?: FindConfig<any> | undefined, sharedContext?: Context | undefined): Promise<OrderTypes.OrderDTO[]>;
    listAndCountOrders(filters?: any, config?: FindConfig<any> | undefined, sharedContext?: Context): Promise<[OrderTypes.OrderDTO[], number]>;
    retrieveReturn(id: string, config?: FindConfig<any> | undefined, sharedContext?: Context): Promise<OrderTypes.ReturnDTO>;
    listReturns(filters?: any, config?: FindConfig<any> | undefined, sharedContext?: Context): Promise<OrderTypes.ReturnDTO[]>;
    listAndCountReturns(filters?: any, config?: FindConfig<any> | undefined, sharedContext?: Context): Promise<[OrderTypes.ReturnDTO[], number]>;
    retrieveOrderClaim(id: string, config?: FindConfig<any> | undefined, sharedContext?: Context): Promise<OrderTypes.OrderClaimDTO>;
    listOrderClaims(filters?: any, config?: FindConfig<any> | undefined, sharedContext?: Context): Promise<OrderTypes.OrderClaimDTO[]>;
    listAndCountOrderClaims(filters?: any, config?: FindConfig<any> | undefined, sharedContext?: Context): Promise<[OrderTypes.OrderClaimDTO[], number]>;
    retrieveOrderExchange(id: string, config?: FindConfig<any> | undefined, sharedContext?: Context): Promise<OrderTypes.OrderExchangeDTO>;
    listOrderExchanges(filters?: any, config?: FindConfig<any> | undefined, sharedContext?: Context): Promise<OrderTypes.OrderExchangeDTO[]>;
    listAndCountOrderExchanges(filters?: any, config?: FindConfig<any> | undefined, sharedContext?: Context): Promise<[OrderTypes.OrderExchangeDTO[], number]>;
    ...
    protected updateOrders_(dataOrIdOrSelector: OrderTypes.UpdateOrderDTO[] | string | Partial<OrderTypes.FilterableOrderProps>, data?: OrderTypes.UpdateOrderDTO, sharedContext?: Context): Promise<any[]>;
    ...
    protected softDeleteOrderShippingMethods_<TReturnableLinkableKeys extends string>(ids: string | object | string[] | object[], config?: SoftDeleteReturn<TReturnableLinkableKeys>, sharedContext?: Context): Promise<Record<string, string[]> | void>;
    ...
    protected restoreOrderShippingMethods_<TReturnableLinkableKeys extends string>(ids: string | object | string[] | object[], config?: RestoreReturn<TReturnableLinkableKeys>, sharedContext?: Context): Promise<Record<string, string[]> | void>;
    ...
    protected createOrderLineItemAdjustments_(orderIdOrData: string | OrderTypes.CreateOrderLineItemAdjustmentDTO[] | OrderTypes.CreateOrderLineItemAdjustmentDTO, adjustments?: OrderTypes.CreateOrderLineItemAdjustmentDTO[], sharedContext?: Context): Promise<InferEntityType<typeof OrderLineItemAdjustment>[]>;
    ...
    protected upsertOrderLineItemAdjustments_(adjustments: (OrderTypes.CreateOrderLineItemAdjustmentDTO | OrderTypes.UpdateOrderLineItemAdjustmentDTO)[], sharedContext?: Context): Promise<InferEntityType<typeof OrderLineItemAdjustment>[]>;
    ...
    protected setOrderLineItemAdjustments_(orderId: string, adjustments: (OrderTypes.CreateOrderLineItemAdjustmentDTO | OrderTypes.UpdateOrderLineItemAdjustmentDTO)[], sharedContext?: Context): Promise<InferEntityType<typeof OrderLineItemAdjustment>[]>;
    ...
    protected upsertOrderShippingMethodAdjustments_(adjustments: (OrderTypes.CreateOrderShippingMethodAdjustmentDTO | OrderTypes.UpdateOrderShippingMethodAdjustmentDTO)[], sharedContext?: Context): Promise<InferEntityType<typeof OrderShippingMethodAdjustment>[]>;
    ...
    protected setOrderShippingMethodAdjustments_(orderId: string, adjustments: (OrderTypes.CreateOrderShippingMethodAdjustmentDTO | OrderTypes.UpdateOrderShippingMethodAdjustmentDTO)[], sharedContext?: Context): Promise<InferEntityType<typeof OrderShippingMethodAdjustment>[]>;
    ...
    protected upsertOrderLineItemTaxLines_(taxLines: (OrderTypes.CreateOrderLineItemTaxLineDTO | OrderTypes.UpdateOrderLineItemTaxLineDTO)[], sharedContext?: Context): Promise<InferEntityType<typeof OrderLineItemTaxLine>[]>;
    ...
    protected setOrderLineItemTaxLines_(orderId: string, taxLines: (OrderTypes.CreateOrderLineItemTaxLineDTO | OrderTypes.UpdateOrderLineItemTaxLineDTO)[], sharedContext?: Context): Promise<InferEntityType<typeof OrderLineItemTaxLine>[]>;
    ...
    protected createOrderShippingMethodTaxLines_(orderIdOrData: string | OrderTypes.CreateOrderShippingMethodTaxLineDTO[] | OrderTypes.CreateOrderShippingMethodTaxLineDTO, taxLines?: OrderTypes.CreateOrderShippingMethodTaxLineDTO[] | OrderTypes.CreateOrderShippingMethodTaxLineDTO, sharedContext?: Context): Promise<InferEntityType<typeof OrderShippingMethodTaxLine>[]>;
    ...
    protected setOrderShippingMethodTaxLines_(orderId: string, taxLines: (OrderTypes.CreateOrderShippingMethodTaxLineDTO | OrderTypes.UpdateOrderShippingMethodTaxLineDTO)[], sharedContext?: Context): Promise<InferEntityType<typeof OrderShippingMethodTaxLine>[]>;
    ...
    confirmOrderChange(data: OrderTypes.ConfirmOrderChangeDTO[], sharedContext?: Context): any;
    protected confirmOrderChange_(orderChangeIdOrData: string | string[] | OrderTypes.ConfirmOrderChangeDTO | OrderTypes.ConfirmOrderChangeDTO[], sharedContext?: Context): Promise<OrderTypes.OrderChangeReturn>;
    ...
    declineOrderChange(data: OrderTypes.DeclineOrderChangeDTO[], sharedContext?: Context): any;
    protected declineOrderChange_(orderChangeIdOrData: string | string[] | OrderTypes.DeclineOrderChangeDTO | OrderTypes.DeclineOrderChangeDTO[], sharedContext?: Context): Promise<void>;
    registerOrderChange(data: OrderTypes.RegisterOrderChangeDTO, sharedContext?: Context): Promise<OrderTypes.OrderChangeDTO>;
    registerOrderChange(data: OrderTypes.RegisterOrderChangeDTO[], sharedContext?: Context): Promise<OrderTypes.OrderChangeDTO[]>;
    protected registerOrderChange_(data: OrderTypes.RegisterOrderChangeDTO | OrderTypes.RegisterOrderChangeDTO[], sharedContext?: Context): Promise<InferEntityType<typeof OrderChange> | InferEntityType<typeof OrderChange>[]>;
    applyPendingOrderActions(orderId: string | string[], sharedContext?: Context): Promise<OrderTypes.OrderChangeReturn>;
    protected applyPendingOrderActions_(orderId: string | string[], sharedContext?: Context): Promise<OrderTypes.OrderChangeReturn>;
    ...
    addOrderAction(data: OrderTypes.CreateOrderChangeActionDTO[], sharedContext?: Context): Promise<OrderTypes.OrderChangeActionDTO[]>;
    protected addOrderAction_(data: OrderTypes.CreateOrderChangeActionDTO | OrderTypes.CreateOrderChangeActionDTO[], sharedContext?: Context): Promise<InferEntityType<typeof OrderChangeAction>[]>;
    ...
    private softDeleteOrderTransactions_;
    ...
    private restoreOrderTransactions_;
