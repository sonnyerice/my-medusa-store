...
class ProductCategoryService extends (0, utils_1.MedusaInternalService)(_models_1.ProductCategory) {
    ...
    async delete(ids, sharedContext = {}) {
        const subscriber = (0, utils_1.createMedusaMikroOrmEventSubscriber)([_models_1.ProductCategory.name], this.container["productModuleService"]);
        (0, utils_1.registerInternalServiceEventSubscriber)(sharedContext, subscriber);
        const deletedIds = await this.productCategoryRepository_.delete(ids, sharedContext);
        ...
        if (deletedIds.length) {
            ...
            deletedIds.forEach((id) => {
                eventManager.dispatchEvent(core_1.EventType.afterDelete, {
                    entity: { id },
                    meta: {
                        className: _models_1.ProductCategory.name,
                    },
                });
            });
        }
