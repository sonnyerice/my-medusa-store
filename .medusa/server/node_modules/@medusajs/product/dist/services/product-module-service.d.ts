...
import { Product, ProductCategory, ProductCollection, ProductImage, ProductOption, ProductOptionValue, ProductTag, ProductType, ProductVariant } from "../models";
...
export default class ProductModuleService extends ProductModuleService_base implements ProductTypes.IProductModuleService {
    ...
    upsertProductTags(data: ProductTypes.UpsertProductTagDTO, sharedContext?: Context): Promise<ProductTypes.ProductTagDTO>;
    protected upsertProductTags_(data: ProductTypes.UpsertProductTagDTO[] | ProductTypes.UpsertProductTagDTO, sharedContext?: Context): Promise<InferEntityType<typeof ProductTag>[]>;
    ...
    upsertProductTypes(data: ProductTypes.UpsertProductTypeDTO, sharedContext?: Context): Promise<ProductTypes.ProductTypeDTO>;
    protected upsertProductTypes_(data: ProductTypes.UpsertProductTypeDTO | ProductTypes.UpsertProductTypeDTO[], sharedContext?: Context): Promise<InferEntityType<typeof ProductType>[]>;
    ...
    upsertProductCollections(data: ProductTypes.UpsertProductCollectionDTO, sharedContext?: Context): Promise<ProductTypes.ProductCollectionDTO>;
    protected upsertCollections_(data: ProductTypes.UpsertProductCollectionDTO[] | ProductTypes.UpsertProductCollectionDTO, sharedContext?: Context): Promise<InferEntityType<typeof ProductCollection>[]>;
    ...
    upsertProductCategories(data: ProductTypes.UpsertProductCategoryDTO, sharedContext?: Context): Promise<ProductTypes.ProductCategoryDTO>;
    protected upsertProductCategories_(data: ProductTypes.UpsertProductCategoryDTO[] | ProductTypes.UpsertProductCategoryDTO, sharedContext?: Context): Promise<InferEntityType<typeof ProductCategory>[]>;
    ...
    protected updateProductCategories_(idOrSelector: string | ProductTypes.FilterableProductTypeProps, data: ProductTypes.UpdateProductCategoryDTO, sharedContext?: Context): Promise<InferEntityType<typeof ProductCategory>[]>;
    ...
    protected updateProductOptionValues_(normalizedInput: ({
        id: string;
    } & ProductTypes.UpdateProductOptionValueDTO)[], sharedContext?: Context): Promise<InferEntityType<typeof ProductOptionValue>[]>;
    /**
