...
exports.Migration20250828075407 = void 0;
const migrations_1 = require("@mikro-orm/migrations");
class Migration20250828075407 extends migrations_1.Migration {
    async up() {
    ...
    `);
        ...
        if (resultCount > 0) {
            console.log(`Warning: Found ${resultCount} buy-get promotions with null apply_to_quantity. These should be fixed as apply_to_quantity is required for proper buy-get promotion functionality.`);
        }
        this.addSql(`
...
exports.Migration20250828075407 = Migration20250828075407;
//# sourceMappingURL=Migration20250828075407.js.map