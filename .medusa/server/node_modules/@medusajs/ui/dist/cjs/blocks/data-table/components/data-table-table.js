...
const data_table_sortable_header_cell_1 = require("./data-table-sortable-header-cell");
const data_table_non_sortable_header_cell_1 = require("./data-table-non-sortable-header-cell");
/**
...
const DataTableTable = (props) => {
    ...
    const handleDragEnd = (event) => {
        ...
        if (active.id !== (over === null || over === void 0 ? void 0 : over.id) && (over === null || over === void 0 ? void 0 : over.id)) {
            ...
            if (oldIndex !== -1 && newIndex !== -1) {
                const newOrder = (0, sortable_1.arrayMove)(currentOrder, oldIndex, newIndex);
    ...
    return (React.createElement("div", { className: "flex w-full flex-1 flex-col overflow-hidden" },
        instance.emptyState === types_1.DataTableEmptyState.POPULATED && (instance.enableColumnOrder ? (React.createElement(core_1.DndContext, { sensors: sensors, collisionDetection: core_1.closestCenter, onDragEnd: handleDragEnd },
            React.createElement("div", { ref: scrollableRef, onScroll: handleHorizontalScroll, className: "min-h-0 w-full flex-1 overflow-auto overscroll-none border-y" },
                React.createElement(table_1.Table, { className: "relative isolate w-full" },
                    React.createElement(table_1.Table.Header, { className: "shadow-ui-border-base sticky inset-x-0 top-0 z-[1] w-full border-b-0 border-t-0 shadow-[0_1px_1px_0]", style: { transform: "translate3d(0,0,0)" } }, instance.getHeaderGroups().map((headerGroup) => (React.createElement(table_1.Table.Row, { key: headerGroup.id, className: (0, clx_1.clx)("border-b-0", {
                        ...
                        React.createElement(sortable_1.SortableContext, { items: sortableItems, strategy: sortable_1.horizontalListSortingStrategy }, headerGroup.headers.map((header, idx) => {
                            var _a, _b;
                            ...
                            const HeaderCellComponent = isDraggable ? data_table_sortable_header_cell_1.DataTableSortableHeaderCell : data_table_non_sortable_header_cell_1.DataTableNonSortableHeaderCell;
                            return (React.createElement(HeaderCellComponent, { key: header.id, id: header.id, isFirstColumn: isFirstColumn, className: (0, clx_1.clx)("whitespace-nowrap", {
                                    ...
                                    : undefined },
                                React.createElement(Wrapper, { type: canSort ? "button" : undefined, onClick: canSort ? sortHandler : undefined, onMouseDown: canSort ? (e) => e.stopPropagation() : undefined, className: (0, clx_1.clx)("group flex cursor-default items-center gap-2", {
                                    ...
                                    canSort && isRightAligned && (React.createElement(data_table_sorting_icon_1.DataTableSortingIcon, { direction: sortDirection })),
